...
<template>
  <div style="display: flex;
    ...
    <a class="btn btn-danger" target="__blank" @click="logout"> se déconnecter
      <BootstrapIcon icon="door-open-fill" id="power" size="1rem" color="white" font-weight="bold"/>
    </a>
  </div>
  <div style="display: flex;
    justify-content: flex-end;">
    <a class="btn btn-light" target="__blank" @click="goHome"> acceuil
      <BootstrapIcon icon="house-door-fill" id="house" size="1rem" color="black" gap="1rem" font-weight="bold"/>
    </a>
  </div>
  <div class="container">
    <div class="main-body">
